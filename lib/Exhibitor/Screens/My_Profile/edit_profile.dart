                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: DropdownButton<String>(
                                  value: profileDetails['data']['salutation'],
                                  onChanged: (String? newValue) {
                                    if (newValue != null) {
                                      setState(() {
                                        profileDetails['data']['salutation'] =
                                            newValue;
                                        editedProfile['salutation'] = newValue;
                                      });
                                    }
                                  },
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                onChanged: (value) {
                                  ...
                                  profileDetails['data']['designation'] = value;
                                  // });
                                },
                              ),
                            ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FormBuilderDropdown(
                      ...
                      onChanged: (value) {
                        setState(() {
                          ...
                          editedProfile['category_name'] = selectedItem['name'];
                    ...
                    Container(
                      ...
                      child: Text(
                        profileDetails['data']['mobile_number'],
                        ...
                        children: [
                          ...
                          SearchDropdown(
                            ...
                            onSearchResults:
                              ...
                              editedProfile['pincode'] = profileDetails['data']
                                      ['pincode'] =
                                  postalAddress['pincode'].toString();
                              editedProfile['city'] = profileDetails['data']
                                  ['city'] = postalAddress['districtname'];
                              editedProfile['state'] = profileDetails['data']
                                  ['state'] = postalAddress['statename'];
                              country = true;
                            },
                          ),
                        ],
                    ...
                    Visibility(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 5),
                          TextFormField(
                              initialValue: profileDetails['data']['pincode'],
                              decoration: InputDecoration(
                                enabledBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10.0),
                                  borderSide: BorderSide(color: AppColor.grey),
                              ...
                              onChanged: (value) {
                                editedProfile['pincode'] =
                                    profileDetails['data']['pincode'] = value;
                              }),
                        ],
                      ),
                    ),
