...
import 'package:medicall_exhibitor/Exhibitor/Screens/Products/products_screen.dart';
                ...
                if (productPage != null &&
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if (allProducts[index]['images'].length == 0)
                        return Container(
                          ...
                          child: Row(
                            children: [
                              GestureDetector(
                                onTap: () {
                                  _pickImage(allProducts[index]['id']);
                                },
                                child: Stack(
                                    ...
                                    Center(
                                      child: Container(
                                        ...
                                        child: FittedBox(
                                          child: Text(
                                            'Add Image',
                                            style: AppTextStyles.whitelabel1,
                                          ),
                                        ),
                                      ),
                                    ),
                      ...
                      else if (allProducts[index]['images'].length == 1)
                        return Container(
                          decoration: BoxDecoration(
                            color: Colors.transparent,
                          ),
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        allProducts[index]['images'][0]['path'],
                                        fit: BoxFit.fill,
                                      ),
                                    ),
                                  ),
