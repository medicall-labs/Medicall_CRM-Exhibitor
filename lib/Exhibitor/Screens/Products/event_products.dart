  ...
  Widget build(BuildContext context) {
    for (int i = 0; i < profileDetails['data']['events'].length; i++) {
      ...
      if (profileDetails['data']['events'][i]['id'] >=
        ...
        eventProducts[profileDetails['data']['events'][i]['id']] = productId;
      }
    }
    return Consumer<LocalDataProvider>(
      builder: (context, localData, child) => Container(
        ...
        children: [
          for (int i = 0; i < profileDetails['data']['events'].length; i++)
            if (profileDetails['data']['events'][i]['id'] >= localData.eventId)
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: FittedBox(
                            ...
                            child: Text(
                              profileDetails['data']['events'][i]['name'] ??
                                  'N/A',
                              ...
                              showModalBottomSheet(
                                ...
                                builder: (context) {
                                  return ProductSearchBottomSheet(
                                    eventName: profileDetails['data']['events']
                                        [i]['name'],
                                    eventId: profileDetails['data']['events'][i]
                                        ['id'],
                                  );
                                },
                              );
                    ...
                    if (profileDetails['data']['events'][i]['products'] != null)
                      Padding(
                        padding: const EdgeInsets.only(left: 20, top: 5),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            for (var eventProduct in profileDetails['data']
                                    ['events'][i]['products'] ??
                                [])
                              Row(
                                children: [
